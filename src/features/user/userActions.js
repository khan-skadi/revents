...
import { FETCH_USER_EVENTS } from '../event/eventConstants.js';
...
export const cancelGoingToEvent = event => async (
  ...
  try {
    await firestore.update(`events/${event.id}`, {
      [`attendees.${user.uid}`]: firestore.FieldValue.delete() // remove a specific field in a document
    });
    await firestore.delete(`event_attendee/${event.id}_${user.uid}`); // remove whole document
